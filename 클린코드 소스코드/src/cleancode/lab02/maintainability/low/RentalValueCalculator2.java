//package lab02.maintainability.low;
//
//import java.util.*;
//
//class Resident {
...
//
//    /* 특정 집의 거주자 수를 계산 */
//    public double countResidents(String houseName) {
//       int count = 0;
//
//       Resident[] residents = rentalBook.getAllResidents();
//
...
//
//        rentalBook.addResident(new Resident("둘리 하우스", "100", "Adult", "유비"));
//        rentalBook.addResident(new Resident("둘리 하우스", "100", "Adult", "관우"));
//        rentalBook.addResident(new Resident("둘리 하우스", "100", "Adult", "장비"));
//        rentalBook.addResident(new Resident("둘리 하우스", "100", "Children", "아두"));
//        rentalBook.addResident(new Resident("둘리 하우스", "101", "Adult", "조조"));
//        rentalBook.addResident(new Resident("둘리 하우스", "101", "Animal", "바둑이"));
//        rentalBook.addResident(new Resident("둘리 하우스", "102", "Adult", "손권"));
//
//        rentalBook.addResident(new Resident("뽀로로 하우스", "101", "Adult", "송강"));
//        rentalBook.addResident(new Resident("뽀로로 하우스", "101", "Adult", "노지심"));
//        rentalBook.addResident(new Resident("뽀로로 하우스", "101", "Adult", "무송"));
//
...
//        printRentalStatus(manager, "뽀로로 하우스", "101");
//    }
//
...
//            System.out.println(" 거주자 이름 : " + roomResidents[i].getName() + "," + " 임대비 : " + roomResidents[i].calculateRentalValue());
//
//        System.out.println("************************************************************");
//
//    }
